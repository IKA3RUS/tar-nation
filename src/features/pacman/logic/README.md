...
| reference data        | [`../data/`](../data/) (`result.example.json`) and [`src/data/state-composition.json`](../../../data/state-composition.json) |
...
`distance`. Reference `M` is `src/data/state-composition.json` (33 rows,
